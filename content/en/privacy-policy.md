...
- **Cookies** are small files placed on Your computer, mobile device, or any other device by a website. They contain the details of Your browsing history on that website, among many other uses.
...
We use Cookies and similar tracking technologies to track activity on Our Service and store certain information. The tracking technologies used include beacons, tags, and scripts, which are employed to collect and track information, as well as to improve and analyze Our Service. The technologies We use may include:
...
- **For the performance of a contract**: This covers the formulation, compliance with, and performance of the purchase contract for the products, items, or services You have purchased, or any other contract with Us through the Service.
