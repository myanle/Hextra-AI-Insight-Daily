...
When you access the Service with a mobile device, we may automatically collect certain information. This includes, but isn't limited to, the type of mobile device you use, your mobile device's unique ID, your mobile device's IP address, your mobile operating system, the type of mobile Internet browser you use, unique device identifiers, and other diagnostic data.
...
-   **To manage your Account**: This involves managing your registration as a user of the Service. The Personal Data you give can provide you with access to different functionalities of the Service that are available to you as a registered user.
...
-   **To contact You**: We will reach out to you via email, telephone calls, SMS, or other equivalent forms of electronic communication, like push notifications from a mobile application. This is to inform you about updates or informative communications related to the functionalities, products, or contracted services, including security updates, when these are necessary or reasonable for their implementation.
