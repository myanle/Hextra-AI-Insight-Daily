...
### Interpretation
Words starting with a capital letter have defined meanings under the following conditions. The following definitions shall have the same meaning whether they appear in singular or in plural.
...
#### Personal Data
While using our Service, we might ask for certain personal data that helps us contact or identify you. This info could include, but isn't limited to:
...
We use Cookies and similar tracking technologies to track activity on our Service and store certain information. The tracking technologies used include beacons, tags, and scripts, which help us collect and track information, and to improve and analyze our Service. The technologies we use may include:
...
- **To provide and maintain our Service** 🛠️: This includes monitoring the usage of our Service.
...
- **For the performance of a contract** ✍️: This means developing, complying with, and undertaking the purchase contract for the products, items, or services you have purchased or any other contract with us through the Service.
...
- **To provide You with news** 📰: We'll send you special offers and general information about other goods, services, and events which we offer that are similar to those you have already purchased or enquired about, unless you have opted not to receive such information.
- **To manage Your requests** ✅: This is about attending to and managing your requests to Us.
...
Before the changes take effect, we will let you know via email and/or a prominent notice on Our Service, and we'll update the "Last updated" date at the top of this Privacy Policy.
