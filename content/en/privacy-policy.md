...
### Interpretation
Words capitalized at the beginning have meanings defined under the following conditions. The following definitions shall have the same meaning, whether they appear in singular or plural form.
...
We use Cookies and similar tracking technologies to track the activity on our Service and store certain information. The tracking technologies used include beacons, tags, and scripts, which are employed to collect and track information and to improve and analyze our Service. The technologies we use may include:
