...
We use Cookies and similar tracking technologies to track activity on our Service and store certain information. The tracking technologies used include beacons, tags, and scripts. These are employed to collect and track information and to improve and analyze our Service. The technologies we use may include:
...
- **To contact You**: We use email, telephone calls, SMS, or other equivalent forms of electronic communication (like a mobile application's push notifications) to contact you regarding updates or informative communications related to the functionalities, products, or contracted services, including security updates, when these are necessary or reasonable for their implementation.
...
Before the changes become effective, we will let you know via email and/or a prominent notice on our Service. We will also update the "Last Updated" date at the top of this Privacy Policy.
